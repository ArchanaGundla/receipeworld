        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">contact@recipeworld.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">123 Recipe Street<br />Culinary City, CC 12345</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-orange-500 to-amber-500 rounded-2xl p-8 text-white">
              ...
              <p className="text-white/90">
                Have a recipe you'd like to see on our platform? Send us your suggestions 
                and we'll do our best to include them in our collection!
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-orange-500 to-amber-500 text-white py-3 px-6 rounded-lg font-medium hover:from-orange-600 hover:to-amber-600 transition-all duration-200 flex items-center justify-center space-x-2"
              >
